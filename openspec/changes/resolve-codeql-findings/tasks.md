...
- [ ] 5.2 Dismiss alerts #31–#56 as false positives, documenting that each condition is Stream Deck message/device dispatch, UI-state selection, or required-value validation rather than authorization.
...
- [ ] 5.4 Record any alert that does not close as follow-up work rather than dismissing an unexplained result.
